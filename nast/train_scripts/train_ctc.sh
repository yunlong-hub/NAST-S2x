...
ENCODER_PRETRAINED_PATH=/workspace/yunlong/NAST-S2x/checkpoints/fr-en/pretrain_encoder/checkpoint_best.pt
CHECKPOINT_DIR=./checkpoints/${LANG}-en/ctc_train
NAST_DIR=./nast
CONFIG_PATH=/workspace/yunlong/NAST-S2x/configs/nast/${LANG}-en
LOG_FILE=${CHECKPOINT_DIR}/log/ctc_train.log
...
fairseq-train ${DATA} \
    ...
    --best-checkpoint-metric bleu_unit --maximize-best-checkpoint-metric --keep-best-checkpoints 10 \
    --num-workers 1 \
